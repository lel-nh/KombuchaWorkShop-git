...
// RAW
#define NUM_RX            5 // Columns are doing the sensing
#define NUM_TX            5 // Row are doing the pull ground
...
class Muca {
  ...
  private:
    ...
    bool RX_lines[NUM_RX] = {1,1,1,1,1}; 			 // RX Lines to skip
    bool TX_lines[NUM_TX] = {1,1,1,1,1}; // TX lines to skip
